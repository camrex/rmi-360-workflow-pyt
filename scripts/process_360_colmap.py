...
Ext. Dependencies:    pycolmap, opencv-python, scipy, pillow, numpy, tqdm
...
try:
    ...
    print("ERROR: pycolmap not found. Install with: pip install pycolmap", file=sys.stderr)
    print("", file=sys.stderr)
    print("Quick setup:", file=sys.stderr)
    print("  1. Create virtual environment: python -m venv E:\\envs\\colmap-processing", file=sys.stderr)
    print("  2. Activate: E:\\envs\\colmap-processing\\Scripts\\Activate.ps1", file=sys.stderr)
    print("  3. Install: pip install pycolmap opencv-python scipy pillow numpy tqdm", file=sys.stderr)
    print("", file=sys.stderr)
    print("Or run automated setup: .\\scripts\\setup_colmap_environment.ps1", file=sys.stderr)
    print("See docs/colmap_setup.md for detailed instructions.", file=sys.stderr)
    sys.exit(1)

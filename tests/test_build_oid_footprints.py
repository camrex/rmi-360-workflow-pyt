...
def test_resolve_spatial_reference_valid(monkeypatch):
    ...
    assert sr.wkid == 3857
    logger.custom.assert_called_with("Using projected coordinate system: WKID 3857", indent=2, emoji="📐")
...
def test_resolve_geographic_transformation():
    ...
    logger.custom.assert_called_with("Applying geographic transformation: WGS_1984_(ITRF00)_To_NAD_1983", indent=2, emoji="🌍")
